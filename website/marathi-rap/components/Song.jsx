...
const SongPlayer = ({ Image, file, songName }) => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-900 text-gray-200 p-6 rounded-2xl w-full max-w-lg mx-auto m-5 md:p-8 lg:max-w-xl lg:m-10 shadow-lg transition-transform transform hover:scale-105">
      {/* Song Image */}
